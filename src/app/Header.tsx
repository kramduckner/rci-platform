          ...
          <div className="flex h-16 justify-between">
            ...
            <div className="sm:ml-6 sm:flex sm:items-center">
              ...
              <Menu as="div" className="relative ml-3 ">
                <div>
                  <MenuButton className="relative flex max-w-xs items-center rounded-full bg-white text-sm focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden hidden lg:block">
            ...
            <div className="flex items-center lg:hidden">
              <button
                ...
                className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 mr-auto"
              >
              ...
              {/* Mobile menu button - kept for disclosure functionality if needed */}
              <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden ml-2">
