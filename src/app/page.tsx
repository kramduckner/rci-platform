...
export default async function Page() {
  ...
  const recentDataset = data?.toSorted((a, b) => new Date(b.created_at).getTime() - new Date(a.created_at).getTime())[0];
  const userAccessedDatasets = data?.filter(d => d.user_has_access) || [];
